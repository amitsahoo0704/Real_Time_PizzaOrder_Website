...
- Move promo definitions to a database or admin UI
- Add animated countdown timer on promo banner for urgency
- Add more local hero/poster artwork in `public/img/` and update `resources/views/home.ejs`
- Add automated smoke tests for order flow (Supertest)

If you want I can update the README with a short demo GIF and example screenshots — tell me which screens to capture.
